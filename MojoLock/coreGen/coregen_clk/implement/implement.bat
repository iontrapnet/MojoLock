...
xst -ifn xst.scr
move coregen_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\coregen_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc coregen_clk_exdes.ucf coregen_clk_exdes

echo 'Running map'
map -timing -pr b coregen_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm coregen_clk_exdes -w routed.ncd routed.v
cd ..
